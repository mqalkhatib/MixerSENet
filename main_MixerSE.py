...
DATASET = 'Qingyun'  ## Pingan, Tangdaowan, Qingyun
...
X_train_idx, X_test_idx, y_train, y_test = splitTrainTestSet(indexes, labels, testRatio = 0.90)
...
model.load_weights(f"{DATASET}_MixerSENet.h5")
